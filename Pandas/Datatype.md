...
Pandas mein data **DataFrame** ya **Series** mein store hota hai,  
aur har column ka apna **datatype** hota hai — jaise number, text, date, etc.

# 🐼 Pandas Data Types (Roman Urdu + Easy Words)

| Data Type          | Example        | Matlab (Roman Urdu)                                            | Use / Kab use hota hai                                    |
| ------------------ | -------------- | -------------------------------------------------------------- | --------------------------------------------------------- |
...
| **object**         | "Ali", "Hello" | Ye text ya words hote hain.                                    | Jab hum names, cities, ya koi text data store karte hain. |
